...
import org.TravelAR.library.Httppostaux;
...
public class Login extends Activity {
    ...
    String IP_Server="192.168.0.12";//IP DE NUESTRO PC
    ...
    public void err_login(){
	    ...
	    Intent mainIntent = new Intent().setClass(Login.this,Errorlogin.class);
    ...
    class asynclogin extends AsyncTask< String, String, String > {
        ...
        protected void onPostExecute(String result) {
           ...
           if (result.equals("ok")){
				...
				Intent i=new Intent(Login.this, HomeLogin.class);
